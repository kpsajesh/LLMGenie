# This file for the tesrail api consumption

from __future__ import annotations
import os
from typing import Dict, Any, List

# importing the methods written in the utils file
from src.core.utils import http_post_json, http_get_json
from typing import Any

# Env-driven config (portable mock → real)
TESTRAIL_BASE = os.getenv("TESTRAIL_BASE", "http://localhost:4002") # if the value is not available in env, it will take the default value as http://localhost:4002
TESTRAIL_PROJECT_ID = int(os.getenv("TESTRAIL_PROJECT_ID", "1"))
TESTRAIL_SECTION_ID = int(os.getenv("TESTRAIL_SECTION_ID", "1"))

PRIORITY_MAP = {"Critical": 1, "High": 2, "Medium": 3, "Low": 4}

# This method is to map the LLM generated test cases to testrail payload format
...
# This method is to create test case via testrail api create post call
def create_case(payload: Dict[str, Any], section_id: int | None = None) -> Dict[str, Any]:
    sid = section_id if section_id is not None else TESTRAIL_SECTION_ID # to pick the section id under project
    url = f"{TESTRAIL_BASE}/api/v2/cases/{sid}"
    return http_post_json(url, payload)

# This is to get the list of test cases created based on a project id from testrail api get call
...
# This method is to add the status of test case via testrail api after creating it. Default is set as 3- untested
...
# This method is to get the stats of test cases created based on a project id from testrail api get call
